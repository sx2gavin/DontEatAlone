...
//        return inflater.inflate(R.layout.fragment_restaurant_map, container, false);
        ...
        View v = inflater.inflate(R.layout.fragment_restaurant_map, null, false);

        GoogleMap map = ((SupportMapFragment) getFragmentManager().findFragmentById(R.id.restaurant_map)).getMap();
